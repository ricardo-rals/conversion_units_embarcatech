...
#include "../includes/conversao_volume.h" // Ajuste o caminho conforme necessário
...
void test_litros_para_mililitros() {
    ...
    CU_ASSERT_DOUBLE_EQUAL(litros_para_mililitros(-1.0), -1.0, 0.0001); // Teste de erro
}
...
void test_litros_para_metro_cubico() {
    ...
    CU_ASSERT_DOUBLE_EQUAL(litros_para_metro_cubico(-1.0), -1.0, 0.000001); // Teste de erro
}
...
void test_mililitros_para_litros() {
    ...
    CU_ASSERT_DOUBLE_EQUAL(mililitros_para_litros(-1.0), -1.0, 0.0001); // Teste de erro
}

/* Testes para a função mililitros_para_metro_cubico */
void test_mililitros_para_metro_cubico() {
    ...
    CU_ASSERT_DOUBLE_EQUAL(milililitros_para_metro_cubico(-1.0), -1.0, 0.000001); // Teste de erro
}
...
void test_metro_cubico_para_litros() {
    ...
    CU_ASSERT_DOUBLE_EQUAL(metro_cubico_para_litros(-1.0), -1.0, 0.0001); // Teste de erro
}
...
void test_metros_cubicos_para_mililitros() {
    ...
    CU_ASSERT_DOUBLE_EQUAL(metros_cubicos_para_mililitros(-1.0), -1.0, 0.0001); // Teste de erro
}
